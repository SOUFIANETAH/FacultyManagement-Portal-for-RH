      ...
      <div className="docs-container">
        <div className="docs-page">
          <div className="docs-cards">
            <div className="docs-card" onClick={() => handleCardClick('/administration/docs/docspers')}>
              <div className="icon-container personnel">
            ...
            <div className="docs-card" onClick={() => handleCardClick('/administration/docs/docsetud')}>
              <div className="icon-container etudiants">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="card-icon">
